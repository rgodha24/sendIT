...
export const Route = createFileRoute("/debate/$id")({
  ...
  loader: async ({ params }) => {
    const debate = await getDebateFn({ data: { id: params.id } });
    if (!debate) {
  ...
  head: ({ loaderData }) => {
    return {
      meta: [
        {
          title: loaderData?.question
            ? `${loaderData.question} | sendIT`
            : "sendIT",
        },
        {
          property: "og:title",
          content: loaderData?.question
            ? loaderData.question
            : "Angel vs Devil Debate | sendIT",
        },
        {
          property: "og:description",
          content: "Angel and Devil debate to help you decide",
        },
        {
          property: "og:image",
          content: "/sendit.png",
